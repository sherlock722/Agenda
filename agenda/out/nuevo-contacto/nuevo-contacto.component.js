...
var NuevoContactoComponent = (function () {
    function NuevoContactoComponent(_router, _contactosService) {
        this._router = _router;
        this._contactosService = _contactosService;
    }
    NuevoContactoComponent.prototype.agregarContacto = function (contacto) {
        var _this = this;
        this._contactosService
            .agregarContacto(contacto)
            .subscribe(function () { return _this._router.navigate(["/mis-contactos"]); });
    };
