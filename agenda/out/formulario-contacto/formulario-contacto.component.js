...
var FormularioContactoComponent = (function () {
    function FormularioContactoComponent() {
        this.nuevoContacto = new core_1.EventEmitter();
    }
    FormularioContactoComponent.prototype.notificarCreacionContacto = function (formulario) {
        this.nuevoContacto.emit(formulario.value);
    };
...
], FormularioContactoComponent.prototype, "nuevoContacto", void 0);
